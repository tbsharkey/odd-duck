...
Once you've completed your merge, deploy your GitHub repo using Github Pages{:target="_blank"}. Submit the link to your deployed site for this project.